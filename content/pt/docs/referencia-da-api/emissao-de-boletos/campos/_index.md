...
|beneficiary	|Objeto com os dados do beneficiário. Veja os campos desse `object` [abaixo](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-beneficiary).	|*Object* | [*beneficiary](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-beneficiary)  |
...
|customer|Objeto com os dados do cliente que será informa como pagador no ato de registro do boleto. Veja os campos desse `object` [abaixo](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-customer).		|*Object* | [*customer](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-customer)  |
|discount	|Objeto com os dados referentes ao desconto. Veja os campos desse `object` [abaixo](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-discount).|*Object* | [*discount](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-discount)  |
...
|fee_metadata	|Objeto que identifica detalhes sobre a aplicação da taxa. Veja os campos desse `object` [abaixo](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-fee_metadata).	|*Object* | [*fee_metadata](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-fee_metadata)  |
|fine	|Objeto com os dados referentes a multa. Veja os campos desse `object` [abaixo](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-fine).	|*Object* | [*fine](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-fine)  |
|id	|Identificador único do boleto bancário, no formato UUID4.|	*String* | min: 36 / max: 36 |
|interest	|Objeto com os dados referentes aos juros. Veja os campos desse `object` [abaixo](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-interest).	|*Object* | [*interest](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-interest) |
...
|receiver| Objeto com os dados do sacador avalista. Veja os campos desse `object` [abaixo](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-receiver).	|*Object* | [*receiver](/docs/referencia-da-api/emissao-de-boletos/campos/#campos-do-objeto-receiver)  |
