...
Caso receba como resposta o *status_code: 403*, [clique aqui](/docs/referencia-da-api/recargas/fluxo_challenge/) para ter acesso ao *fluxo de autorização do challenge* (x-stone-challenge-solution). 
