...
```Json
{
    "id": "eee1466a-458a-4afa-87ec-6a52fc3ff331",
...
Caso receba como resposta o *status_code: 403* , [clique aqui](/docs/guias/integracao/panda/authorization/#fluxo-de-autorização-de-challenge) para ter acesso ao *fluxo de autorização do challenge* (x-stone-challenge-solution). 
