...
O Dry Run de pagamentos retorna, além do [Objeto Pagamento](/docs/pagamentos/o-objeto-pagamento/) em si, os Objetos [Barcode Details](#objeto-barcode-details) e [Details](#objeto-details).
