...
| status                 | Status atual do documento na sua instituição emissora.                                      | _String_  | `"payable"` para documentos que podem ser pagos, `"paid"` para documentos já pagos e que não aceitam mais pagamentos, e `"unpayable"` para documentos que não podem ser pagos. |
| total_added_value      | Total que foi adicionado ao valor original do documento decorrente de juros e multas.       | _Integer_ | Opcional. Caso seja boleto bancário, o valor será `null`.                                                                                                                      |
| total_discounted_value | Total que foi abatido do valor originial do documento decorrente de descontos.              | _Integer_ | Opcional. Caso seja boleto bancário, o valor será `null`.                                                                                                                      |
| updatable_value        | Indica se é permitido alterar o valor do documento.                                         | _Boolean_ | Opcional. Caso seja boleto bancário, o valor será `null`.                                                                                                                      |
