...
| counter_party                       | Dados do beneficiário da transação. Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-counter_party)                                   | _Object_  | `external`, `external_refund`, `instant_payment`, `internal`, `salary`, `salary_portability`, `salary_portability_refund`, `salary_portability_employer_refund`                                                                                                                                                             |
...
| account_settlement_policy_retention | Dados da conta em que será realizada a retenção de liquidação de conta. Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-account_settlement_policy_retention) | _Object_  | `loan_payments`                                                                                                                                                                                                                                                                                                             |
| original_operation_entry            | Dados da operação original.Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-original_operation_entry).                                            | _Object_  | `loan_payments`                                                                                                                                                                                                                                                                                                             |
...
| card_acceptor                       | Dados sobre o cartão em que foi realizada a compra. Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-card_acceptor)                    | _Object_  | `outbound_stone_prepaid_card_payment`, `outbound_stone_prepaid_card_payment_refund`, `outbound_stone_prepaid_card_payment_chargeback`, `outbound_stone_prepaid_card_withdrawal`, `outbound_stone_prepaid_card_withdrawal_refund`                                                                                            |
...
| transaction_authorization           | Dados sobre a autorização da transação de uma compra feita com cartão. Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-transaction_authorization) | _Object_  | `outbound_stone_prepaid_card_payment`, `outbound_stone_prepaid_card_payment_refund`, `outbound_stone_prepaid_card_payment_chargeback`, `outbound_stone_prepaid_card_withdrawal`, `outbound_stone_prepaid_card_withdrawal_refund`                                                                                            |
| transaction_chargeback              | Dados sobre o estorno da transação de uma compra feita com cartão. Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-transaction_chargeback)     | _Object_  | `outbound_stone_prepaid_card_payment_chargeback`                                                                                                                                                                                                                                                                            |
...
| Chave   | Descrição               | Tipo     |
| ------- | ----------------------- | -------- |
| account | Dados da conta destino. Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-account)| _Object_ |
| entity  | Dados Pessoais. Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-entity-)        | _Object_ |
...
| applied_retention_rules      | Dados de onde será aplicada as regras de juros.  Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-applied_retention_rules)    | _Object_  |
...
| retained_portion      | Dados sobre a porcentagem dos juros.Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-retained_portion)                                   | _Object_  |
...
| beneficiary                | Dados do beneficário do empréstimo/crédito.  Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-beneficiary)                         | _Object_  |
...
| value                  | Dados do valor convertido pra BRL, com taxas. Veja seus campos [abaixo](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-value)              | _Object_  |
...
| value           | Dados do valor estornado.Veja seus campos [aqui](/docs/dados-da-conta/objetos-do-extrato/#campos-do-objeto-value)                           | _Object_ |
