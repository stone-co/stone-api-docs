...
date: 2020-05-14T18:47:01-03:00
lastmod: 2020-05-14T18:47:01-03:00
weight: "1"
draft: false
---
...
def consent_claims():
 ...
 def consent_link():
    return f"{ACCOUNTS_URL}/#/consent?type=consent&client_id={CLIENT_ID}&jwt={consent_token()}"
```
...
<br>Seguimos alguns padrões para alguns tipos de dados em toda a nossa API. [Aqui](https://docs.openbank.stone.com.br/reference#data-e-hora) se encontram alguns destes padrões.
{{< /notice >}}
...
Utilizando tokens é possível se autenticar e realizar a solicitação de consentimento em contas de usuárias de forma segura.
